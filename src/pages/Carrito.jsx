...
const CartPage = () => {
  ...
  const clearCart = async () => {
    ...
    try {
      const deletePromises = cart.items.map(
        (item) =>
          api.delete(
            `/carritos-items/${item.id_item}/`
          )
      );
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // MERCADO PAGO
      const prefResponse = await api.post(
    ...
    return (
      <div className="min-h-screen bg-[#f6f7fb] flex items-center justify-center px-4">
        <div className="bg-white rounded-[32px] border border-gray-200 shadow-sm p-10 max-w-md w-full">
          ...
          <h1 className="text-3xl font-black text-center text-gray-900 mt-8">
            Inicia sesión
          </h1>

          <p className="text-gray-500 text-center mt-3">
            Accede para continuar con tu
            pedido.
          </p>
          ...
          <div className="bg-white border border-gray-200 rounded-[32px] p-8 shadow-sm">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="uppercase tracking-[0.2em] text-red-500 text-sm font-bold">
                    Pedido
                  </p>

                  <h1 className="text-5xl font-black text-gray-900 mt-2 leading-none">
                    Tu carrito
                  </h1>
                  ...
                  >
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="mt-8 flex items-end justify-between flex-wrap gap-5">
                          {/* QTY */}
                          ...
                          <div className="text-right">
                            ...
                            <h3 className="text-5xl font-black text-gray-900 mt-1">
                              S/{' '}
                              {parseFloat(
                                item.subtotal
                              ).toFixed(
            ...
            <div>
              <div className="sticky top-28 bg-white rounded-[32px] border border-gray-200 shadow-sm p-7">
                ...
                <div className="border border-gray-200 rounded-3xl p-5">
                  ...
                  <h3 className="mt-3 font-black text-xl text-gray-900">
                    {
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <button
                    ...
                    className={`h-16 rounded-2xl font-bold flex items-center justify-center gap-3 transition-all ${
                      deliveryOption ===
                      'delivery'
                  ...
                  <div className="mt-7">
                    ...
                    <div className="flex gap-3 mt-3">
                      <textarea
                        ...
                        placeholder="Ejemplo: Av. Los Pinos 123"
                        rows="4"
                        className="flex-1 border border-gray-200 rounded-2xl p-4 bg-gray-50 outline-none focus:ring-4 focus:ring-red-100 resize-none"
                      />
                      ...
                      <button
                        ...
                        className="w-24 rounded-2xl bg-red-600 hover:bg-red-700 text-white flex flex-col items-center justify-center gap-2 font-bold transition-all"
                      >
                        <Navigation
                          size={22}
                        />
                    ...
                    <div
                      ...
                      className="mt-4 rounded-2xl overflow-hidden border border-gray-200 cursor-pointer"
                    >
                      <MapContainer
                        center={
                          miniMapCenter
                ...
                <button
                  ...
                  className="w-full h-16 mt-7 rounded-2xl bg-gradient-to-r from-red-600 to-red-500 hover:scale-[1.01] transition-all text-white font-black text-xl shadow-xl"
                >
                  {processing
                    ? 'Procesando...'
                    : 'Confirmar pedido'}
                ...
                <button
                  ...
                  className="w-full mt-5 flex items-center justify-center gap-2 text-gray-500 hover:text-red-500 transition-all font-semibold"
                >
                  <ArrowLeft
                    size={18}
                  />
          ...
          <div className="bg-white w-full max-w-5xl rounded-[32px] overflow-hidden shadow-2xl">
            ...
            <div className="p-6 border-t border-gray-200 flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="flex-1 w-full">
                ...
                <div className="bg-gray-100 rounded-2xl p-4 text-gray-700">
                  {isGeocoding
              ...
              <button
                ...
                className="h-14 px-8 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-bold transition-all"
              >
                Confirmar ubicación
              </button>
            </div>
